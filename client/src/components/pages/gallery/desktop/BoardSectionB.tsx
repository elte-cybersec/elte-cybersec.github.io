...
export default function BoardSectionB({
  photos,
  onPhotoClick,
}: BoardSectionBProps) {
  ...
  return (
    ...
    >
      ...
      <ChipSOIC x={801} y={60} width={50} height={36} label="U25" />
      <ChipSOIC x={822} y={605} width={50} height={36} label="U26" />
      ...
      <Capacitor cx={1070} cy={180} r={9} />
      <Capacitor cx={1070} cy={220} r={7} showPolarity={false} />
      <Capacitor cx={1070} cy={470} r={9} />
      <Capacitor cx={1070} cy={510} r={7} showPolarity={false} />
      ...
      <Resistor x={1052} y={60} label="R53" />
      <Resistor x={1052} y={80} />
